...
class SequenceHack:
	...
	def index_finder(self, sequence, hexcode, row, index, prev_index, depth, exclude_list):
		...
		for i in range(len(line)):
			...
			if not coord in exclude_list:
				...
				if line[i] == hexcode:
					...
					tmp_str = (str(i) + self.index_finder(sequence = sequence,
														  hexcode = new_hexcode,
														  row = new_row,
														  index = i,
														  prev_index = i,
	...
	def breach_protocol(self):
		...
		while target_seq_length > (2 * self.BUFFER_SIZE):
			...
			for i in range(num_seq_codes):
				best_seq_options.append(sequence_strings[:i] + sequence_strings[i + 1:])
	
			# get index of longest sequence
			best_index = best_seq_options.index(max(best_seq_options, key=lambda x: len("".join(x))))
		...
		possible_sequences = ["".join(s) for s in list(itertools.permutations(sequence_strings, num_seq_codes))]
		...
		for seq in possible_sequences:
			...
			result = self.index_finder(sequence = list_seq,
									   hexcode = hexcode, 
									   row = True,
									   index = 0,
									   prev_index = 0,
			...
			if result[-1] == "+":
				...
				msg.print_pass("  //BREACHING_STATUS....................................................COMPLETE")
				...
				msg.print_fail("  //BREACHING_STATUS......................................................FAILED")
